...
// VoiceRSS Javascript SDK (modificado por Jacinto)
...
// Mi clave personal obtenida en VoiceRSS https://www.voicerss.org/
// const apiKey = b5f7aad534ad4d98a69fa51424f312b6;
// http://api.voicerss.org/?key=b5f7aad534ad4d98a69fa51424f312b6&hl=en-us&src=Hello, world!

//Pass the joke to the speech to voice functionality (VoiceRSS)
function tellMe(joke) {
    VoiceRSS.speech({
        key: 'b5f7aad534ad4d98a69fa51424f312b6',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
async function getJokes() {
    ...
    try {
        ...
        // Send joke to speech to voice funcion
        tellMe(joke)
    }catch (error) {
        console.log("Error al obtener un chiste. ", error)
    }
}
